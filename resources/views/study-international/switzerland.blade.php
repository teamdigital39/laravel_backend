...
<head>
  ...
  <link href="{{ asset('study-international/assets/css/switzerland.css') }}" rel="stylesheet">
...
<body>
  ...
  <section id="hero-fullscreen" class="hero-fullscreen d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center position-relative" data-aos="zoom-out">
      <h2>Study <span> Hotel Management In Switzerland!</span></h2>
      <p style="font-weight: bolder;">Experience the Luxury of the Hospitality Education from Switzerland</p>
      <!-- <div class="d-flex">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Switzerland as a destination for Hotel Management</h2>
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5">
            <div class="about-img">
              <img src="{{ asset('study-international/assets/img/about-us-switzerland.webp') }}" class="img-fluid" alt="business-management">
            </div>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <ul class="nav nav-pills mb-3">
              <li><a class="nav-link active" data-bs-toggle="pill" href="#tab1">
                Why should you pursue a course in Hotel Management in Switzerland?
              </a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="tab1">
                ...
                <p class="fst-italic"> Switzerland has some of the best colleges teaching courses on hotel management, and pursuing a course on <b>Hotel Management in Switzerland</b>, and from those institutions will provide an opportunity to gain exceptional training, prepare for success in the global hospitality market, along with boosting your career with a background of <b>Swiss Experience</b>.
</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>World-Class Education and Reputation:</h4>
                </div>
                <p>Switzerland is home to the top universities of the world in terms of education, training, and management groups. Ranked among the top twelve globally for employer reputation in hospitality and leisure </i> Accredited by <a href="https://www.topuniversities.com/world-university-rankings"> (<b>QS Global University Ranking</b>)</a></li>, making it one of the best Swiss colleges for international students that is known for providing education renowned for its quality and excellence.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Comprehensive Skill Development:</h4>
                </div>
                <p>All hospitality management degree courses focus on developing leaders in hospitality, business, and culinary management. The unique education platform emphasizes practical skills, entrepreneurship, innovation, and ambition, ensuring students are well-equipped for successful careers.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Unique Learning Environment and Career Opportunities:</h4>
                </div>
                <p>Studying <b>Hotel Management in Switzerland</b> will offer a safe, beautiful environment in the UNESCO Biosphere Soerenberg. Students benefit from internships at the best Swiss hotel and restaurants, gaining invaluable experience and joining a strong global network that supports lifelong career advancement.</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <p>2 Years (Last Year being Optional for Dissertation)</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <p>January, April, August and October</p>
            </div>
          </div>
          <!-- End Service Item -->
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6">
            <div class="content d-flex flex-column justify-content-center h-100">
              ...
              <ul>
                <li><i class="bi bi-check-circle"></i><b>Paid International internships</b> for 4-6 Months- Worldwide and in Switzerland.</li>
                <li><i class="bi bi-check-circle"></i>Earn benefits of a Career Centre, Culinary Centre, Events Centre and Research Centre to gain a professional exposure. </li>
                <li><i class="bi bi-check-circle"></i>Strong Accessibility in the field of Consumer Goods and Capital Services and Projects.</li>
                <li><i class="bi bi-check-circle"></i>Career Forums with 150 partner companies with work and study options.</li>
                <li><i class="bi bi-check-circle"></i>Upto 15 hours of individual confidential coaching sessions with executive coaches to provide permanent support.</li>
                <li><i class="bi bi-check-circle"></i>Benefit from world class corporate and academic partners.</li>
              </ul>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <p>One-to-One interactions with the Admission Officers of the Universities</p>
            </div>
          </div>
          <!-- End Service Item -->
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i> A Student must be aged above 20-21 Years.</li>
                  <li><i class="bi bi-check-circle-fill"></i> A student must have a Post-Graduate Diploma in International Hotel and Tourism Management or a Bachelor’s Degree or Post Graduate Diploma in any discipline.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Language Requirements By Interview/Entrance Examination Conducted by University or TOEFL-547, IELTS-6.0, or University’s English Placement Score.</li>
                  <li><i class="bi bi-check-circle-fill"></i> A strong Statement of Purpose or a Motivation Letter specifying a student’s suitability to pursue the course and selecting a proper career plan based on this course.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Three years of <b>work experience</b> in the field of hospitality and tourism management if a student does not have a degree or a postgraduate diploma. </li>
                </ul>
                <!-- <p>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i>All Courses are taught in English</li>
                  <li><i class="bi bi-check-circle-fill"></i>A student must have taken TOEFL-547, IELTS-6.0, or University’s English Placement Test.</li>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i><b>Contact our counsellors for details related to Course Fees.</b></li>
                  <!-- <li><i class="bi bi-check-circle-fill"></i> Human Resource Management</li> -->
                </ul>
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Recognitions</h3>
                <p class="fst-italic">The Hotel Management Courses in Switerland are recognised as being:-</p>
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i> Ranked 1st in Switzerland and 4th Europe for 2020 EMCup</li>
                  <li><i class="bi bi-check-circle-fill"></i> Ranked Top 13 for 2023 QS University Global Rank for Employer Reputation</li>
                  <li><i class="bi bi-check-circle-fill"></i> Ranked No.7 under the Edinburgh Napier University by The Guardian for Master’s Degree in 2023.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Ranked Top 12 Employer Rank 2022 by QS</li>
                  <li><i class="bi bi-check-circle-fill"></i> Ranked Top 15 Global Rank 2022 by QS</li>
                  <li><i class="bi bi-check-circle-fill"></i> Ranked No. 1 Kanton Luzern Switzerland 2023 by QS</li>
                </ul>
                <!-- <p class="fst-italic">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                  magna aliqua.
            ...
            <div class="accordion accordion-flush px-xl-5" id="faqlist">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  ...
                  Being one of the most important global destinations for businesses, makes it an attractive opportunity to pursue <b>Business Management in France</b>. Also, France is the country of origin for a lot of businesses and industrial start-up initiatives and some of the most world-famous Hotel Chains. 
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                   Are there any opportunities to secure scholarships and even if, then what are the amounts?  
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Yes, there are opportunities for scholarships. But it varies individually according to different courses. In order to know more about the details related to the full tuition fees and scholarships, please <a href="tel:+91-8527282833"><b>Contact Our Team</b></a> . 
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
                    <i class="bi bi-question-circle question-icon"></i>
                    Are there any specific language requirements to pursue these courses in Universities of France?
                  </button>
                </h3>
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                   The requirement and necessity of languages depends upon every institution of France. But being a hub of International Business, does not have any specific language requirements. 
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                    <i class="bi bi-question-circle question-icon"></i>
                    Is it necessary to have any past experience of work and internships to secure admission for Management Courses in France?
                  </button>
                </h3>
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    <i class="bi bi-question-circle question-icon"></i>
                    At the time of the admission it is necessary to provide a copy of your updated Curriculum Vitae (CV), as a part of the Documentation Process, still the student must include a prior experience on the area of study.
                  </div>
                </div>
              </div><!-- # Faq item-->
