...
<head>
  ...
  <link href="{{ asset('study-international/assets/css/management-france.css') }}" rel="stylesheet">
...
<body>
  ...
  <section id="hero-fullscreen" class="hero-fullscreen d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center position-relative" data-aos="zoom-out">
      <h2>Study <span> Business Management in France!</span></h2>
      <p style="font-weight: bolder;">Experience the Entrepreneurial Elegance from Paris to Provence</p>
      <!-- <div class="d-flex">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About France as a destination for studying Business Management</h2>
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5">
            <div class="about-img">
              <img src="{{ asset('study-international/assets/img/about-us-france.png') }}" class="img-fluid" alt="business-management">
            </div>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <ul class="nav nav-pills mb-3">
              <li><a class="nav-link active" data-bs-toggle="pill" href="#tab1">
                Why should you pursue a program on Business Management in France?
              </a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="tab1">
                ...
                <p class="fst-italic"> Pursuing a course on Business Management from France comes with an unique blend of knowledge with giving them the recognition of a <b>world class curriculum</b>. Being in France which hosts technical hubs, and hospitality centers, students benefit from a vibrant international environment, and industry connections.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Prestigious Academic Institutions with Unparalleled Resources:</h4>
                </div>
                <p>France has renowned universities and business schools offering <b>world class curriculum</b> in Business Management. These institutions provide access to state-of-the-art facilities, esteemed faculty, and a global network, ensuring students receive a comprehensive education grounded in academic excellence.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Vibrant Business Landscape:</h4>
                </div>
                <p>Positioned at the crossroads of Europe, France is a thriving hub of business activity and innovation. From bustling metropolises like Paris to dynamic tech clusters such as Sophia Antipolis, students benefit from exposure to diverse industries and cutting-edge research, fostering a dynamic learning experience that transcends the classroom.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Abundant Career Opportunities:</h4>
                </div>
                <p>With a robust economy and a reputation for fostering entrepreneurship and creativity, France offers an abundance of career prospects for graduates who pursue <b>Business management in France</b>. Whether aspiring to work for multinational corporations, start their own ventures, or pursue further academic endeavors, students gain access to a wealth of opportunities that align with their professional aspirations.</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <p>Master's in International Management</p>
            </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <p>Executive MBA- 18 Months</p>
              <p>Master’s of Management- 2 Years</p>
            </div>
          </div><!-- End Service Item -->
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6">
            <div class="content d-flex flex-column justify-content-center h-100">
              ...
              <ul>
                <li><i class="bi bi-check-circle"></i>Bi-lingual Study programmes on both English and French.</li>
                <li><i class="bi bi-check-circle"></i>Lifelong membership with more than 100 network sessions, 18 Alumni and Business Clubs.</li>
                <li><i class="bi bi-check-circle"></i>Benefit of Career Counselling Opportunities through job board, workshops, coaching, entrepreneurial support, Business Nursery and Start-Up Lab.</li>
                <li><i class="bi bi-check-circle"></i>Opportunity to be a part of a Global Networking Domains provided by Universities with prominent national and international firms, as well as dynamic SMEs and start-ups like- Air France, Jaguar Landrover, Johnson & Johnson, Airbus, Boeing, and etc.</li>
                <li><i class="bi bi-check-circle"></i>10% Discount on Early Bird Offers to pay the 1st Year Tuition Fees.</li>
              </ul>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <p>One-to-One interactions with Admission Officers of the Universities</p>
            </div>
          </div>
          <!-- End Service Item -->
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i> Aged under 28 years.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Have prior professional experience in the field of Management, minimum of 5 years.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Exhibit a strong motivation and a clear professional objective mentioned through a well-crafted Letter of Motivation to pursue a course of Business Management in France.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Graduate with a Bachelor's Degree from a recognized University.</li>
                </ul>
                <!-- <p>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i><b>For Pursuing the course in French/Bilingual Medium- English test : IELTS: 5, TOEIC: 700, TOEFL: 54-60, Duolingo: 70</b></li>
                  <li><i class="bi bi-check-circle-fill"></i><b>For pursuing the course in English: IELTS: 6, TOEIC: 750, TOEFL: 800, Duolingo: 105</b></li>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i>For a Detailed information on the fees, <a href="tel:+91-8527282833"><b>Contact Us</b></a></li>
                  <!-- <li><i class="bi bi-check-circle-fill"></i> Human Resource Management</li> -->
                </ul>
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Recognitions</h3>
                <p class="fst-italic">The Degrees on Business Management Awarded by the French Universities are recognised by:-</p>
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i> Accreditation of the European Foundation for e-learning quality assurance</li>
                  <li><i class="bi bi-check-circle-fill"></i> Accredited by Association of AMBAS</li>
                  <li><i class="bi bi-check-circle-fill"></i> Accredited by <a href="https://www.unesco.org/en"> UNESCO</a></li>
                  <li><i class="bi bi-check-circle-fill"></i> Accredited by the <a href="http://51.140.24.191/"> Business Graduates Association</a></li>
                </ul>
                <!-- <p class="fst-italic">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                  magna aliqua.
