...
<head>
  ...
  <link href="{{ asset('study-international/assets/css/spain.css') }}" rel="stylesheet">
...
<body>
  ...
  <section id="hero-fullscreen" class="hero-fullscreen d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center position-relative" data-aos="zoom-out">
      <h2>Study <span> Business Management Education in Spain !</span></h2>
      <p style="font-weight: bolder;">Shape your success stories and transform your future from Spain</p>
      <!-- <div class="d-flex">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Business Management Education in Spain</h2>
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5">
            <div class="about-img">
              <img src="{{ asset('study-international/assets/img/about-spain-us.webp') }}" class="img-fluid" alt="business-management">
            </div>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <ul class="nav nav-pills mb-3">
              <li><a class="nav-link active" data-bs-toggle="pill" href="#tab1">
               Why should you pursue Business Management Education in Spain?
              </a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="tab1">
                ...
                <p class="fst-italic">Spain offers some of the premier institutions for <b>Business Management education</b>, providing an exceptional opportunity to gain top-tier training. Studying Business Management in Spain equips students with the skills needed to excel in the global business market while immersing them in a vibrant cultural and economic environment.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Diverse Academic Experience:</h4>
                </div>
                <p>Pursuing a <b>Business Management Education</b> in Spain offers a unique blend of academic rigor, cultural immersion, and career opportunities, with renowned universities and business schools providing globally recognized credentials and fostering personal growth.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Global Business Education:</h4>
                </div>
                <p>Spain has its hub of global businesses, most popular ones being Madrid, and Barcelona. The Universities offering a here offer a range of academic programs like <b>International MBA</b> or an <b>Executive MBA</b>. Utilizing cutting-edge technology like Automation, Artificial Intelligence, and IoT.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Strategic Location for Career Growth:</h4>
                </div>
                <p>Spain is situated at a <b>strategic location</b> in Europe, and serves as a magnet for diverse talents and industries, providing students with access to a global network and opportunities in innovation and entrepreneurship. So, pursuing a <b>business management education</b> from Spain opens doors to diverse career paths.</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Intake Months</a></h4>
              <p>October, January, April</p>
            </div>
          </div>
          <!-- End Service Item -->
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6">
            <div class="content d-flex flex-column justify-content-center h-100">
              ...
              <ul>
                <li><i class="bi bi-check-circle"></i><b>Proximity to a dynamic and exciting location. </li>
                <li><i class="bi bi-check-circle"></i>State-of-the Art Classroom and infrastructure. </li>
                <li><i class="bi bi-check-circle"></i>Scholarships worth 40% to students High Scores in GRE, GMAT, Excellent Work-Experience Record, and Unique Statements of Purposes (SOPs). </li>
                <li><i class="bi bi-check-circle"></i>Innovative Spaces to study and a varied opportunities for adventure.</li>
                <li><i class="bi bi-check-circle"></i>3-4 Years Assistance with Online Job Portal After Graduating.</li>
                <li><i class="bi bi-check-circle"></i>Internship opportunities in both working and 20-21 work hours on weekends at an average worth of 13-18 Euros.</li>
                <li><i class="bi bi-check-circle"></i>Career Fair, and Alumni Relations.</li>
                <li><i class="bi bi-check-circle"></i>Accomodation near Campus.</li>
                <li><i class="bi bi-check-circle"></i>Work Visa upto 1 year.</li>
                <li><i class="bi bi-check-circle"></i>Placement with Top Tier Companies.</li>
              </ul>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <p>One-to-One interactions with University Admission Officers</p>
            </div>
          </div>
          <!-- End Service Item -->
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i> Bachelor’s Degree from a recognised University with Business, Social Sciences, or Business Studies.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Professional Experience of minimum 3 years in either Private/Public Sector/Volunteering.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Students from Non-Business Background will be Eligible to Apply after clearing Internal Admission Exams conducted by the Universities along with presenting a strong Motivation Letter.</li>
                </ul>
                <!-- <p>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i>All Courses are taught in <b>English</b></li>
                  <li><i class="bi bi-check-circle-fill"></i>TOEFL with Minimum Score 213 (computer based), 79/93 (internet based), 550 (paper-based) and IELTS Minimum 6.5</li>
                  <li><i class="bi bi-check-circle-fill"></i>Cambridge ESOL, Certificate in Advanced English (CAE) with Minimum score: C1</li>
                  <li><i class="bi bi-check-circle-fill"></i>Spanish not Compulsory</li>
                  <!-- <li><i class="bi bi-check-circle-fill"></i> Human Resource Management</li> -->
                </ul>
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="{{ asset('study-international/assets/img/france-language-requirements.png') }}" alt="features-synergy-2" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                ...
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i><b>Application Fee: 100 Euros</b></li>
                  <li><i class="bi bi-check-circle-fill"></i><b>Registration Fee: 200 Euros </b></li>
                  <li><i class="bi bi-check-circle-fill"></i><b>Administrative Fees: 950 Euros</b></li>
                  <!-- <li><i class="bi bi-check-circle-fill"></i> Human Resource Management</li> -->
                </ul>
              </div>
              <div class="col-lg-4 order-1 order-lg-2 text-center">
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              <div class="col-lg-8 order-2 order-lg-1">
                <h3>Recognitions</h3>
                <p class="fst-italic">The Universities of Spain are recognised as being:-</p>
                <ul>
                  <li><i class="bi bi-check-circle-fill"></i> Leader in Digital Education</li>
                  <li><i class="bi bi-check-circle-fill"></i> Named under the <a href="https://www.microsoft.com/en-us/education/school-leaders/showcase-schools"> Microsoft Showcase School</a></li>
                  <li><i class="bi bi-check-circle-fill"></i> Recognised by the <a href="https://www.unwto.org/"> UNWTO.</a></li>
                  <li><i class="bi bi-check-circle-fill"></i> QS Star Rating System for best Teaching Faculty.</li>
                  <li><i class="bi bi-check-circle-fill"></i> MBA Program ranked under CEO Tier One Global MBA Rankings for 2023.</li>
                  <li><i class="bi bi-check-circle-fill"></i> Recognized as a Leader in Global Education for Newsweek Magazine.</li>
                </ul>
                <!-- <p class="fst-italic">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                  magna aliqua.
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="post-box">
              <div class="post-img"><img loading="lazy" src="{{ asset('study-international/assets/img/services-switzerland.webp') }}" class="img-fluid" alt="services spain" width="416" height="312"></div>
              <!-- <div class="meta">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="post-box">
              <div class="post-img"><img loading="lazy" src="{{ asset('study-international/assets/img/russia-our-services.png') }}" class="img-fluid" alt="services france" width="416" height="312"></div>
              <!-- <div class="meta">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="post-box">
              <div class="post-img"><img loading="lazy" src="{{ asset('study-international/assets/img/france-for-switzerland-our-services.webp') }}" class="img-fluid" alt="services switzerland" width="416" height="312"></div>
              <!-- <div class="meta">
                <span class="post-date">Fri, September 05</span>
                <span class="post-author"> / Mario Douglas</span>
              </div> -->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                    ...
                    What is the scope of pursuing a course on Business Management in France?
                  </button>
                </h3>
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                  In order to secure a visa for Spain, along with the documentation, Langma Study International, which is a part of <b>Langma School of Languages</b> will help you to connect and arrange a counselling session to ensure a hassle-free process.  
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                   Is there any necessary language criteria to pursue an MBA program in Spain?  
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    The medium of academic instruction is followed in English. But still students will also be eligible if they have a good score in IELTS/TOEFL/Duolingo or an Educational background in English. 
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
                    <i class="bi bi-question-circle question-icon"></i>
                    Which are the best cities to pursue business education in Spain?
                  </button>
                </h3>
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                   In Spain, the cities of Madrid, and Barcelona, are considered to be the most important cities for pursuing education on <b>Business Management Education</b>, because of the presence of some of the <a href="https://www.studying-in-spain.com/plan-your-studies/universities/top-business-schools-in-spain/"> <b>Top Business Schools</b>.</a> 
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                    <i class="bi bi-question-circle question-icon"></i>
                     What are the probable practice areas and opportunities that a student can pursue in Spain after the completion of their MBA Courses? 
                  </button>
                </h3>
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    <i class="bi bi-question-circle question-icon"></i>
                    Being a home for the <b>Top Business Schools</b>, Spain hosts a range of opportunities in various sectors of the country where students can take up jobs as paid interns to work on both week-days and weekends for 20-21 hours on an average.
                  </div>
                </div>
              </div><!-- # Faq item-->
