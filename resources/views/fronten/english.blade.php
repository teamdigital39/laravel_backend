			...
			<div class="swiper-container swiper-parent swiper-fade swiper-initialized swiper-horizontal swiper-pointer-events">
				<div class="swiper-wrapper" id="swiper-wrapper-ee76ab81fb6796eb" aria-live="off" style="cursor: grab; transition-duration: 0ms;">
					...
					<div class="swiper-slide dark swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 1902px; transition-duration: 0ms; opacity: 1; transform: translate3d(-1902px, 0px, 0px);">
						<div class="swiper-slide-bg" style="background-image: url({{ asset('normal_images/english-landing.webp' ) }}); background-position: bottom center;"></div>
						<!--. $bg_banner-->
					</div>
                </div>
            </div>
...
============================================= -->
                ...
                <h3>ABOUT ENGLISH</h3>
               <p>English for Academics at Langma School of Languages will give an introduction to the academic language and skills that are required to pursue an education at a university. The programme at Langma School of Languages is intensive and needs the dedication to pursue it since university students undertake: listening to lectures, taking notes, spoken presentations, reading long sentences and visual information, presenting opinions on literary and writing reports using appropriate literary terms. During this programme, you will be asked to share your work with the teacher as well with students and give and receive feedback in the class.</p>
               <p>This programme covers how great writers presented their opinions on different topics and their works are seen when they intervene in our global cultural landscape today. We are evident that none of the literature has ever been inspired in isolation from the cultures around it; since the “Old English” (Anglo-Saxon), great works of literature have examined the strife, tensions, and connections among neighbouring countries and the distant one. The programme is aimed at focusing especially on the works of literature which include the experience of the wider spectrum as their theme; furthermore, it will explore the varied artistic modes in which great writers have presented their views according to the context, helping us to materialise the deep roots of today’s intertwined global cultures.</p>
               <p>This programme will help you to improve your literary understanding and examination of Austen, Shakespeare, Burns, Wordsworth, Wilde, and many more. Humans have liaised their thoughts, feelings, and ideas through several medium and poetry is one of them throughout the human civilisation. The poem can state the new truths about human experience; however, to comprehend it as it is presented is difficult without expert knowledge.  This course would help you build confidence in reading and enjoying poetry. Irrespective of you being a poetry fanatic or eager to learn, you need tools for approaching the study of poetry, how to express your appreciation of poetry, and pursue new riches in your favourite poems. The programme would also give you insight and guidance on developing your own poetic voice when writing verse. You will also learn as a part of this programme how literary works and books are transformed by cultural transmission. </p>
