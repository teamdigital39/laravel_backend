...
============================================= -->
                ...
                <h3>ABOUT US</h3>
               <p><b>Langma School of Languages</b> is a reputed <b>French language institute</b> with about a decade of experience in <b>French language training.</b>We are proud to announce that we have successfully imparted French training to government officials, corporate professionals, embassies and many more.</p>
              <p>We are the accredited exam center for conducting <b>ECL (European Consortium for the Certificate of Attainment in Modern Languages) exam.</b> For training purposes, we follow the Common European Framework of Reference for Languages (CEFR). We are also a preparation centre for <b>DELF (Diplôme d'Etudes en Langue Française)</b> and <b>DALF (Diplôme Approfondi de Langue Française)</b> exams</p>
               <p>Our strong suit is the <b>Guaranteed Learning Programme</b>, where we assure you knowledge of a particular level till the student is satisfied. For instance, we will provide you multiple training of French A1 level until you are satisfied, before moving on to A2 level. What is more, all of this is available without paying extra fees!</p>
               <img src="https://langmainternational.com/normal_images/about french.png">
                </div>
                <!-- .postcontent end -->
...
============================================= -->
           ...
           <div class="col-lg-4">
               <h4><b>ABOUT ECL</b></h4>
                <p>European Consortium for the Certificate of Attainment in Modern Languages (ECL) is a standardised language test for the major European Union (EU) languages. As part of the ECL testing four skills are tested: oral communication, listening comprehension, written communication and reading comprehension. ECL certificates are officially recognized in the European Union as a document confirming the level of language competence, which is necessary for participation in any international education programs, work and migration.</p>
           </div>
           <div class="col-lg-6">
               <h4><b>BENEFITS OF FRENCH</b></h4>
               <ol>
                   <li>280 million speakers worldwide</li>
                   <li>Advantage in the international job market</li>
                   <li>Study opportunities at renowned French universities</li>
                   <li>A language for learning other languages</li>
                   <li>Offers insights into France’s culture</li>
                   <li>One of the United Nations Official Languages</li>
               </ol>
               <h4><b>WHY LANGMA</b></h4>
               <ol>
                   <li>Work on personality, other than language training</li>
                   <li>Native and non-native teachers.</li>
                   <li>ECL accredited centre</li>
                   <li>Online/Offline classes</li>
                   <li>Guaranteed Learning Programme</li>
                   <li>DELF/DALF preparation centre</li>
               </ol>
           </div>

          </div>
            <div class="postcontent col-lg-9">
          <iframe width="100%" height="40" src="https://www.youtube.com/embed/I2qn5ZHq5LI" frameborder="0" allow="accelerometer; autoplay=1; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
             <!-- .sidebar end -->
                          <div class="postcontent col-lg-9">
                <div class="section footer-stick bg-white">
					...
					<div id="oc-clients-full" class="owl-carousel owl-carousel-full image-carousel carousel-widget" data-margin="30" data-nav="true" data-pagi="false" data-autoplay="2000" data-items-xs="3" data-items-sm="3" data-items-md="4" data-items-lg="4" data-items-xl="4">
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/French 3.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/French 2.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/french 1.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/french-4.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/French 3.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/French 2.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/french 1.png') }}" alt="Brands"></a></div>
						<div class="oc-item"><a href="#"><img src="{{ asset('normal_images/french-4.png') }}" alt="Brands"></a></div>
