			...
			<div class="swiper-container swiper-parent swiper-fade swiper-initialized swiper-horizontal swiper-pointer-events">
				<div class="swiper-wrapper" id="swiper-wrapper-ee76ab81fb6796eb" aria-live="off" style="cursor: grab; transition-duration: 0ms;">
					...
					<div class="swiper-slide dark swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 1902px; transition-duration: 0ms; opacity: 1; transform: translate3d(-1902px, 0px, 0px);">
						<div class="swiper-slide-bg" style="background-image: url({{ asset('normal_images/spanish-landing.webp' ) }}); background-position: bottom center;"></div>
						<!--. $bg_banner-->
					</div>
                </div>
            </div>
...
============================================= -->
                ...
                <h3>ABOUT SPANISH</h3>
                <p>Langma School of Language offers several options for students who wish to pursue General Spanish Language course. Since the number of Institution offering General Spanish Language course are limited and one has to choose graduate programme to study; however, if you are ready to take on the challenge to seek out the opportunity to do so, Langma School of Language will help you set yourself apart from the rest and help yourself stand out from a crowd. It is the time to show that you are committed to learn something new!</p>
                <p>Langma School of Language offers General Spanish Language course to students, corporate, and government bodies in various levels to suit the specific needs. Programmes are divided into 6 levels “Beginner (A1 & A2)”, “Intermediate (B1 & B2)”, and “Advanced (C1 & C2)”. There are both weekday and weekend classes. Langma School of Language is more than mere educational facility, our specialised services includes translation, interpretation, voice-over, and etc.</p>
                <p>Spanish Language for Beginners (A1 & A2) (Starters & Elementary)</p>
                <p>Spanish Language for Beginners at Langma School of Language are aimed at participants who wish to have rudimentary knowledge, rapid progress, and improve their language skills. That means students would learn Spanish language with its culture, tradition, and history. The programme at Langma School of Language is intended to put emphasis on everyday Spanish Language and the classes are designed whilst bearing the beginner level in mind. The primary objective of the programme is to offer an ability to employ the Spanish language to communicate and share basic information. The programme at Langma School of Language begins to instil with the fundamentals of language such as alphabet and numbers. The classes are based on pragmatic approach; so, students can build vocabulary and grammar is incorporated to help students create sentences. Teachers work on individuals to improve pronunciation. At the end of the programme students will be able to: use greetings and farewells, introduce themselves, clear and precise pronunciation, talk about family, leisure time, study, work, weather, use basic sentence structures for communication, asking questions, shopping, making plans & arrangements, read basic texts, understand simple written messages like streets, stores, cafes, and write simple messages. Teachers would share some fascinating facts about the Spanish culture and traditions. Teachers may play some short video, or ask students to share their opinion on particular points which bring another lighter aspect to the programme.</p>
