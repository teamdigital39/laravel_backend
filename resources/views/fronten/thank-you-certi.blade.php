	...
	<!-- Content
		...
		<section id="content">
			<div class="content-wrap">
				...
				<div class="col-lg-12">
                                <div class="vertical-middle text-center"> 
                                <h4 class="display-4" style="color: var(--bs-orange);">If you have any query call this number </h4> 
                                    <h5 class="display-5" style="color: var(--bs-orange);">Rohit - <a href="tel:9643743796">+91-9643743796</a></h5>
                                </div>
...
<script>
  ...
  gtag('config', 'UA-40542391-1');
        ...
        <script>
  gtag('event', 'conversion', {'send_to': 'AW-1001957978/XJ6sCOrjsdoDENrU4t0D'});
</script>
@endsection
