...
@section('content')
    @php
    $action = !empty($item) ? route('client.update', $item->id) : route('client.store');
    @endphp
    ...
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            ...
            <h1 class="h3 d-inline align-middle">Client/</h1>
        ...
        <div class="row mb-2 mb-xl-3">
            ...
            <div class="col-auto ms-auto text-end mt-n1">
                ...
                <a href="{{ route('client.index') }}" class="btn btn-primary">SHOW LISTS</a>
            </div>
        </div>
