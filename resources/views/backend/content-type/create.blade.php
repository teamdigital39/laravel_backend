...
@section('content')
    @php
    $action = !empty($item) ? route('content-type.update', $item->id) : route('content-type.store');
    @endphp
    ...
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            ...
            <h1 class="h3 d-inline align-middle">Content-Type/</h1>
...
<h3><strong>Analytics</strong> Dashboard</h3>
            ...
            <div class="col-auto ms-auto text-end mt-n1">
                ...
                <a href="{{ route('content-type.index') }}" class="btn btn-primary">SHOW LISTS</a>
            </div>
        </div>
                                ...
                                <select name="type" class="form-select" required>
                                    ...
                                    @foreach (('\App\Models\Type')::get() as $type)
                                        <option value="{{ $type->id }}"
                                            {{ !empty($item) && $item->type == $type->id ? 'selected' : '' }}>
                                            {{ $type->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            @if (!empty($item) && $item->banner)
                                <div class="form-control" style="padding-top:10px;">
                                    <img class="form-control" src="{{ asset('normal_images/' . $item->banner) }}"
                                        width="80" height="80">
                                </div>
                            @endif
