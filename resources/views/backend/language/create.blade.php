...
@section('content')
    @php
    $action = !empty($item) ? route('language.update', $item->id) : route('language.store');
    @endphp
    ...
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            ...
            <h1 class="h3 d-inline align-middle">Language/</h1>
...
<h3><strong>Analytics</strong> Dashboard</h3>
            ...
            <div class="col-auto ms-auto text-end mt-n1">
                ...
                <a href="{{ route('language.index') }}" class="btn btn-primary">SHOW LISTS</a>
            </div>
        </div>
...
<input type="password" class="form-control" placeholder="Password">
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <select name="typeid" class="form-select">
                                    ...
                                    @foreach (('\App\Models\PageType')::get() as $type)
                                        <option value="{{ $type->id }}"
                                            {{ !empty($item) && $type->id == $item->type ? 'selected' : '' }}>
                                            {{ $type->title }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Enter Content Description</label>
                                <textarea name="content_2" id="summernote_2"
                                    class="form-control">{!! !empty($item) ? $item->content_2 : old('content_2') !!}</textarea>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                class="form-control"
                                name="seo_keyword"
                                    value="{{ !empty($item) ? $item->seo_keyword : old('seo_keyword') }}"
                                    type="text"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                class="form-control"
                                name="seo_url"
                                    value="{{ !empty($item) ? $item->url : old('url') }}"
                                    type="text"
