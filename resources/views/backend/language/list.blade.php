                ...
                <div class="card-body">
                    <div class="row mb-2 mb-xl-3">
                        ...
                        <div class="col-auto ms-auto text-end mt-n1">
                            ...
                            <a href="{{ route('language.create') }}" class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                    ...
                    @foreach ($datas as $key=>$data)
                            <tr>
                                <td>{{$key+1}}</td>
                                <td><img width="50" class="mr-3"
                                    src="{{asset('normal_images/'.$data->image )}}"></td>
                                    <td><a href="{{ url('admin/language-page/'.$data->id) }}">{{$data->title}}</a>
                                    </td>

                                 {{-- <td>{{ $data->title }}</td>
                                <td>{{ucfirst($data->page_type->title)}}</td> --}}
                                {{-- <td>{{ $page->type }}</td> --}}
                                {{-- <td>{{ $page->url  }}</td>
                                <td>{{ $page->content }}</td>
                                <td>{{ $page->content_2 }}</td>
                                <td>{{ $page->image }}</td>
                                <td>{{ $page->banner }}</td>
                                <td>{{ $page->aid }}</td>
                                ...
                                {{-- <td>{{ $page->position }}</td> --}}
                                 ...
                                 <td class="table-action">
                                    <a href="{{ route('language.edit', $data->id) }}">
