...
@section('content')
    @php
    $action = !empty($item) ? route('affiliation.update', $item->id) : route('affiliation.store');
    @endphp
    ...
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            ...
            <h1 class="h3 d-inline align-middle">Affiliation/</h1>
...
<h3><strong>Analytics</strong> Dashboard</h3>
            ...
            <div class="col-auto ms-auto text-end mt-n1">
                ...
                <a href="{{ route('affiliation.index') }}" class="btn btn-primary">SHOW LISTS</a>
            </div>
        </div>
