...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn German Language with Langma School of Languages" />
        ...
        <title>Learn German Language with Langma School of Languages</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="https://langmainternational.com/learn-german-language" class="logo">
        ...
        <section class="section main-banner" id="top" data-section="section1">
            <video class="lazy" autoplay muted loop playsinline id="bg-video" style="width: 100%;">
                <source src="assets/images/germany-landing-video.mp4" type="video/mp4" />
            </video>
            ...
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>Learn German with Langma</h1>
                    </div>
                                ...
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            <b><span style="color: #f5a425;">At Langma School of Languages,</span></b>
                                            we carefully choose the teachers who can focus on exam preparation and are familiar with the testing patterns, and the expectations of examiners. Our trainers will help you to understand the
                                            benefits of various German language levels. Langma School of Languages offers lessons for individuals who are in dire need of an extra dimension/attention or groups that rquire an overall
                                            development.
                                        </p>
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            International Exam Preparation programme at Langma School of Languages is designed to prepare you for the <span style="color: #f5a425;">Goethe or TELC</span>. Langma offers an integrated learning
                                            experience. Our programmes are short and tailored on the basis of various German language levels to assure your International German Examination Success. These tests are accepted in Germany,
                                            Austria, and Luxembourg for the purpose of Employment, Immigration, and University enrolment. The course consists of the practice of all four modules
                                            <span style="color: #f5a425;">(Goethe or TELC)</span> Listening, Reading, Writing, & Speaking. Langma School of Languages offers classroom and online GOETHE exam preparation and is recognised as
                                            one of the best training centres globally. Our teachers share tips, techniques, vocabulary, and grammar for Speaking and Writing. We mark your work and focus on helping you overcome your weakness.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="meetings-page" id="about">
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>REASON TO LEARN GERMAN LANGUAGE</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            <b><span style="color: #f5a425;">German</span></b>
                                            is the 3rd highest spoken Language in Europe. German Language(Deutsch) is a West-Germanic language that is majorly spoken in Central Europe. Moreover, it is an official and co-official language of
                                            many European countries like Germany, Austria, Switzerland, Liechtenstein, Luxembourg, Hungary, Poland, and Denmark. It is most similar to other West Germanic languages – including Afrikaans,
                                            Dutch, and English. Furthermore, the similarities in vocabulary can be seen in languages like Danish, Swedish, and Norwegian.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="video">
                            <iframe
                                width="560"
                                height="377"
                                src="https://www.youtube.com/embed/_2XXNtxEDHc?autoplay=1&amp;mute=1"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <h2 class="text-center">German Course Levels</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
