...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn Russian Language with Langma School of Languages" />
        ...
        <title>Learn Russian Language with Langma School of Languages</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="https://langmainternational.com/learn-russian-language" class="logo">
        ...
        <section class="section main-banner" id="top" data-section="section1">
            <video autoplay muted loop playsinline id="bg-video" style="width: 100%;">
                <source src="https://langmainternational.com/assets/images/russia-landing-video.mp4" type="video/mp4" />
            </video>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            ...
                                            <h1 style="color: #f5a425; font-size: 16px;" class="display-4">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <form id="contact" action="apply-submit" autocomplete="off" method="post">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" id="language" name="language" value="russian" onpaste="return false;" />
            ...
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>Learn Russian with Langma</h1>
                    </div>
                                ...
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            ...
                                            main objective is to provide exceptional teaching to students of all ages and levels, from school standard to professional, academics no matter what background or discipline they are engaged in,
                                            and we aim to exceed the expectations of our students by providing outcomes derived from the excellence of our training. Langma’s programme would provide the highest standard of foreign language
                                            training and encourage sustainable development with innovation in an environment of creative language acquisition.
                                        </p>
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            <span style="color: #f5a425;">International Exam Preparation programme</span> at Langma School of Languages is designed to prepare you for the <span style="color: #f5a425;">TORFL</span>. Langma
                                            offers an integrated learning experience. Our programmes are short and tailored to assure your International Russian Examination Success. This test is accepted in Russia for the purpose of
                                            Employment, Immigration, and University enrolment. The course consists of practice of all four modules <span style="color: #f5a425;">(TORFL)</span> Listening, Reading, Writing, & Speaking. Langma
                                            School of Languages offers classroom and online training and is recognised as one of the best training centres globally. The teacher would share tips, technique, vocabulary, and grammar for
                                            Speaking and Writing. We mark you work and focuses on helping you overcome your weakness.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="meetings-page">
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>REASON TO LEARN RUSSIAN LANGUAGE</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            <b><span style="color: #f5a425;">Russia</span></b>
                                            is the biggest country in the whole world. It is also the only country washed by a dozen seas. Its area is also known – 17,075,400 square kilometres. The Trans-Siberian Railway is the longest
                                            railway on our planet. The road was continuously built for 25 years – from 1891 to 1916. It cost 1.5 billion Roubles to build it and about 300 million Roubles to reconstruct it after the Civil
                                            War. The Great Siberian Way has a length of 9298 kilometres. It crosses 8 time zones, passes through 87 cities and towns and crosses 16 rivers, including the Volga.The economy of Russia is an
                                            upper middle income mixed and transition economy. It is the 5th largest economy in Europe. The 11th largest in the world in terms of nominal GDP, and 5th largest by purchasing power parity.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="video">
                            <iframe
                                width="560"
                                height="377"
                                src="https://www.youtube.com/embed/-Y2w2HgPWUw?autoplay=1&amp;mute=1"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <h2 class="text-center fs-2">Russian Course Levels</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="owl-courses-item owl-carousel">
                            <div class="item">
                                <div class="rounded down-content">
                                    <h4><span class="d-none">learn-russian-language</span><i class="fa fa-graduation-cap" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">EDUCATION</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-russian-language</span><i class="fa fa-users" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">BUSINESS & ADMIN</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-russian-language</span><i class="fa fa-building" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">POLITICS & GOVERNMENT</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-russian-language</span><i class="fa fa-globe" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">TOURISM</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-russian-language</span><i class="fa fa-hospital-o" style="font-size: 100px; color: #0d6efd;"></i></h4>
