...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn Japanese Language with Langma School of Language" />
        ...
        <title>Learn Japanese Language with Langma School of Language</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="https://langmainternational.com/learn-japanese-language" class="logo">
        ...
        <section class="section main-banner" id="top" data-section="section1">
            <video autoplay muted loop playsinline id="bg-video" style="width: 100%;">
                <source src="https://langmainternational.com/assets/images/japan-landing-video.mp4" type="video/mp4" />
            </video>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            ...
                                            <h1 style="color: #f5a425;" class="display-4">LEARN JAPANESE LANGUAGE</h1>
            ...
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>Learn Japanese with Langma</h1>
                    </div>
                  ...
                  <p>Recreio dos Bandeirantes, Rio de Janeiro - RJ, 22795-008, Brazil</p>   -->
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            ...
                                            is the best foreign language institute offering Japanese language programmes globally. Our institute is a pioneer of Japanese language training. Our dedicated teachers help students to prepare
                                            “Japanese Language Proficiency Test” (<span style="color: #f5a425;">JLPT</span>) and <span style="color: #f5a425;">NAT</span> Test. <span style="color: #f5a425;">JLPT</span> is conducted by the
                                            Japanese Government throughout the world on the first Sunday of July and December every year. <span style="color: #f5a425;">NAT</span> Test is conducted by Senmon Kyouiku Publishing House, Tokyo.
                                        </p>

                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            Our native teachers are proficient to help you succeed in the exams. Our institution has successfully helped thousands of students to attain their goals. Learning the Japanese language would open
                                            doors for you to various career options throughout the world.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="meetings-page">
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>REASON TO LEARN JAPANESE LANGUAGE</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            <b><span style="color: #f5a425;">Japan</span></b>
                                            is the third-largest economy in the world after China and the United States, and the Japanese language is the 9th most spoken language in the world. The Japanese Diaspora can be seen as present in
                                            several other countries like Brazil, U.S, UK, Peru, etc.
                                        </p>
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            Like every other language and its rules, Japanese is no different from others. To learn this language from scratch requires an ample amount of time and enthusiasm. But why should one learn the
                                            Japanese language?
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="meeting-item">
                                    <div class="thumb">
                                        <img src="https://langmainternational.com/assets/images/1.webp" loading="lazy" width="300" height="300" alt="Plot Form The Trusted Developer" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="meeting-item">
                                    <div class="thumb">
                                        <img src="https://langmainternational.com/assets/images/2.webp" loading="lazy" width="300" height="300" alt="Property Features" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="meeting-item">
                                    <div class="thumb">
                                        <img src="https://langmainternational.com/assets/images/3.webp" loading="lazy" width="300" height="300" alt="Premium Plots For Sale" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="meeting-item">
                                    <div class="thumb">
                                        <img src="https://langmainternational.com/assets/images/4.webp" loading="lazy" width="300" height="300" alt="New Booking Open" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="meeting-item">
                                    <div class="thumb">
                                        <img src="assets/images/5.webp" loading="lazy" width="300" height="300" alt="Looking To Invest In Dehradun" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="meeting-item">
                                    <div class="thumb">
                                        <img src="https://langmainternational.com/assets/images/6.webp" loading="lazy" width="300" height="300" alt="Exclusive Property Near Dehradun" />
                                        <!-- </a> -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="video">
                            <iframe
                                width="560"
                                height="377"
                                src="https://www.youtube.com/embed/ZZGRd7373vY?autoplay=1&amp;mute=1"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <h2 class="text-center fs-2">Japanese Course Levels</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="owl-courses-item owl-carousel">
                            <div class="item">
                                <div class="rounded down-content">
                                    <h4>N5</h4>
                                    <h4 class="text-white bg-success">Basic</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4>N4</h4>
                                    <h4 class="text-white bg-success">Intermediate</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4>N3</h4>
                                    <h4 class="text-white bg-success">Pre-Advance</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4>N2</h4>
                                    <h4 class="text-white bg-success">Advance</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4>N1</h4>
                                    <h4 class="text-white bg-success">Super Advance</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="owl-courses-item owl-carousel">
                            <div class="item">
                                <div class="rounded down-content">
                                    <h4><span class="d-none">Japanese</span><i class="fa fa-graduation-cap" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">EDUCATION</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">Japanese</span><i class="fa fa-users" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">BUSINESS & ADMIN</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">Japanese</span><i class="fa fa-building" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">POLITICS & GOVERNMENT</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">Japanese</span><i class="fa fa-globe" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">TOURISM</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">Japanese</span><i class="fa fa-hospital-o" style="font-size: 100px; color: #0d6efd;"></i></h4>
