...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn Spanish Language with Langma School of Languages" />
        ...
        <title>Learn Spanish Language with Langma School of Languages</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="https://langmainternational.com/learn-spanish-language" class="logo">
        ...
        <section class="section main-banner" id="top" data-section="section1">
            <video autoplay muted loop playsinline id="bg-video" style="width: 100%;">
                <source src="https://langmainternational.com/assets/images/spanish-landing-video.mp4" type="video/mp4" />
            </video>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <form id="contact" action="apply-submit" autocomplete="off" method="post">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" id="language" name="language" value="spanish" onpaste="return false;" />
            ...
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>Learn Spanish with Langma</h1>
                    </div>
                                ...
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            ...
                                            offers several options for students who wish to pursue General Spanish Language course. Since the number of Institution offering General Spanish Language course are limited and one has to choose
                                            graduate programme to study; however, if you are ready to take on the challenge to seek out the opportunity to do so, Langma School of Language will help you set yourself apart from the rest and
                                            help yourself stand out from a crowd. It is the time to show that you are committed to learn something new!
                                        </p>
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            Langma School of Language offers General Spanish Language course to students, corporate, and government bodies in various levels to suit the specific needs. Programmes are divided into 6 levels
        ...
        <section class="meetings-page">
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>REASON TO LEARN SPANISH LANGUAGE</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            450 million of <b><span style="color: #f5a425;">Spanish</span></b> speakers are native speakers. It is estimated that there are more than 21 million students of Spanish as a foreign language.
                                            Spanish is the second most studied language in the world. It is the official and second official language of more than 22 countries and is also spoken in numerous other countries. This includes
                                            the United States there are 45 million Spanish speakers making it the second largest Spanish-speaking countries in the world and is expected to become the largest by 2050.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="video">
                            <iframe
                                width="560"
                                height="377"
                                src="https://www.youtube.com/embed/3NMlzcqqrWY?autoplay=1&amp;mute=1"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <h2 class="text-center fs-2">Spanish Course Levels</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="owl-courses-item owl-carousel">
                            <div class="item">
                                <div class="rounded down-content">
                                    <h4><span class="d-none">learn-spanish-language</span><i class="fa fa-graduation-cap" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">EDUCATION</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-spanish-language</span><i class="fa fa-users" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">BUSINESS & ADMIN</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-spanish-language</span><i class="fa fa-building" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">POLITICS & GOVERNMENT</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-spanish-language</span><i class="fa fa-globe" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">TOURISM</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-spanish-language</span><i class="fa fa-hospital-o" style="font-size: 100px; color: #0d6efd;"></i></h4>
