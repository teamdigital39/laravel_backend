...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn Korean Language with Langma School of Languages" />
        ...
        <title>Learn Korean Language with Langma School of Languages</title>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="https://langmainternational.com/learn-korean-language" class="logo">
        ...
        <section class="section main-banner" id="top" data-section="section1">
            <video autoplay muted loop playsinline style="width: 100%;">
                <source src="https://langmainternational.com/assets/images/korean-landing-video.mp4" type="video/mp4" />
            </video>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <form id="contact" action="apply-submit" autocomplete="off" method="post">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" id="language" name="language" value="korean" onpaste="return false;" />
            ...
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>Learn Korean with Langma</h1>
                    </div>
                                ...
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            ...
                                            General Korean is the most considered option for those who want to <span style="color: #f5a425;">learn Korean </span>fast and easy. Our professional and highly experienced teachers will guide you
                                            from beginner to advanced level in a friendly atmosphere with students all over the world. Teachers at Langma School of Language are highly qualified, experienced professionals who majored in
                                            teaching Korean as a foreign language. High-quality teaching has been constantly proven by the language skills of our students. Monitoring students’ progress every week, they adjust the programme
                                            accordingly to your result.
                                        </p>
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            Langma School of Language offers Korean language programme to students, corporate, and government bodies in various levels to suit the specific needs. Programmes are divided into 6 levels
                                            <span style="color: #f5a425;">“Beginner (Level 1 & Level 2 )”</span>, <span style="color: #f5a425;">“Intermediate (Level 3 & Level 4)”</span>, and
                                            <span style="color: #f5a425;">“Advanced (Level 5 & Level 6 )”</span>. Additionally, our methodology is aimed to enable students to pass the
                                            <span style="color: #f5a425;">"Test of Proficiency in Korean"</span> or <span style="color: #f5a425;">TOPIK</span> with the desired score. There are both weekday and weekend classes. Langma School
                                            of Language is more than mere educational facility, our specialised services includes translation, interpretation, voice-over, and etc.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="meetings-page" id="about">
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>REASON TO LEARN KOREAN LANGUAGE</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            <b><span style="color: #f5a425;">Korean</span></b>
                                            language is spoken by more than 75 million people, 48 million in South Korea and 24 million in North Korea. Other than that there are more than 2 million speakers in China, approximately 1 million
                                            in the United States, and about 500,000 in Japan. Korean is the official language of both South Korea (Republic of Korea) and North Korea (Democratic People’s Republic of Korea).
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="video">
                            <iframe
                                width="560"
                                height="377"
                                src="https://www.youtube.com/embed/-yd90J67lVE?autoplay=1&amp;mute=1"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="owl-courses-item owl-carousel">
                            <div class="item">
                                <div class="rounded down-content">
                                    <h4><span class="d-none">learn-korean-language</span><i class="fa fa-graduation-cap" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">EDUCATION</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-korean-language</span><i class="fa fa-users" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">BUSINESS & ADMIN</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-korean-language</span><i class="fa fa-building" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">POLITICS & GOVERNMENT</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-korean-language</span><i class="fa fa-globe" style="font-size: 100px; color: #0d6efd;"></i></h4>
                                    <h4 class="text-white bg-success">TOURISM</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><span class="d-none">learn-korean-language</span><i class="fa fa-hospital-o" style="font-size: 100px; color: #0d6efd;"></i></h4>
