...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Learn English Language with Langma School of Languages" />
        <meta name="author" content="learn-english-language" />
        ...
        <title>Learn English Language with Langma School of Languages</title>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="#" class="logo">
                                <img src="https://langmainternational.com/assets/images/logo-english.webp" width="207" height="70" alt="thesunvillagelogo" style="image-rendering: -webkit-optimize-contrast; width: 150px;" />
                            </a>
                        </nav>
                    </div>
                </div>
        ...
        <section class="section main-banner" id="top" data-section="section1">
            <video autoplay muted loop playsinline id="bg-video" style="width: 100%;">
                <source type="video/mp4" src="https://langmainternational.com/assets/images/eng1.mp4" />
            </video>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            ...
                                            <h1 style="color: #f5a425; font-size: 16px;" class="display-4">LEARN ENGLISH LANGUAGE</h1>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <form id="contact" action="apply-submit" autocomplete="off" method="post">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <fieldset>
                                                                            <input name="email" type="email" id="email" pattern="[^ @]*@[^ @]*" placeholder="EMAIL *" required onpaste="return false;" />
                                                                        </fieldset>
                                                                    </div>
                                                                    ...
                                                                    <input type="hidden" id="language" name="language" value="english" onpaste="return false;" />
            ...
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>Learn English with Langma</h1>
                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            English language course can help you speak English correctly and eloquently in many parts of your life. Enrolling in a reputable English-speaking course can help you speak English correctly and
                                            fluently. However, it is important to select the appropriate English-speaking course for you to avoid wasting your time, effort, and money. Without a doubt, Langma School of Languages provides the
                                            best English-Speaking Course in South Delhi with outstanding outcomes.
                                        </p>
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            International Exam Preparation programme at Langma School of Languages is designed to prepare you for the
                                            <span style="color: #f5a425;">IELTS , OET , CELPIP , PTE , TOEFL , GRE , GMAT , & SAT</span>. Langma offers an integrated learning experience. Our programmes are short and tailored to assure your
                                            International English Examination Success. These tests are accepted worldwide for the purpose of Employment, Immigration, and University enrolment. The course consists of the practice of all four
                                            modules <span style="color: #f5a425;">(OET, CELPIP, PTE, IELTS, & TOEFL)</span> Listening, Reading, Writing, & Speaking and <span style="color: #f5a425;">(GRE, GMAT, & SAT)</span> Verbal and
                                            Quantitative Reasoning, & Analytical writing. Langma School of Languages offers classroom and online training and is recognised as one of the best training centres globally. The teacher would
                                            share tips, technique, vocabulary, and grammar for Speaking and Writing. We mark your work and focuses on helping you overcome your weakness.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="meetings-page" id="about">
            <div class="container">
                <div class="row">
                    <div style="text-align: center; margin-top: -80px; margin-bottom: 50px; padding-bottom: 20px; font-size: 22px; font-weight: 700; text-transform: uppercase; color: #fff;">
                        <h1>REASON TO LEARN ENGLISH LANGUAGE</h1>
                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="meeting-single-item">
                                    <div class="down-content">
                                        <p class="description" style="border-top: 0px solid #eee; margin-top: -48px; margin-bottom: -48px; border-bottom: 0px solid #eee; font-size: 19px; line-height: 37px;">
                                            English is spoken by over <span style="color: #f5a425;">360</span> million people throughout the world and is taught in over <span style="color: #f5a425;">118</span> countries, making it a very
                                            valuable language to learn. Learning English will help you to communicate effectively with people from all over the world, making travel much easier and giving you a greater knowledge of different
                                            cultures. The importance of the English language can be seen in almost every aspect of our lives. This is especially true in the business world, where English is the most spoken language, and most
                                            employers expect some level of English proficiency throughout the hiring process. Investing in an excellent English language course will boost your work possibilities significantly.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="video">
                            <iframe
                                width="560"
                                height="377"
                                src="https://www.youtube.com/embed/KIueNtbz_jI?autoplay=1&amp;mute=1"
        ...
        <section class="our-courses" id="courses" style="padding-top: 91px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                            <h2 class="fs-2 text-center">English Course Levels</h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
        ...
        <section class="our-courses" style="padding-top: 0px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading">
                    ...
                    <div class="col-lg-12">
                        <div class="owl-courses-item owl-carousel">
                            <div class="item">
                                <div class="rounded down-content">
                                    <h4><i class="fa fa-graduation-cap" style="font-size: 100px; color: #0d6efd;"></i> <span class="d-none">fa-graduation-cap</span></h4>
                                    <h4 class="text-white bg-success">EDUCATION</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><i class="fa fa-users" style="font-size: 100px; color: #0d6efd;"></i> <span class="d-none">fa-users</span></h4>
                                    <h4 class="text-white bg-success">BUSINESS & ADMIN</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><i class="fa fa-building" style="font-size: 100px; color: #0d6efd;"></i> <span class="d-none">fa-building</span></h4>
                                    <h4 class="text-white bg-success">POLITICS & GOVERNMENT</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><i class="fa fa-globe" style="font-size: 100px; color: #0d6efd;"></i> <span class="d-none">fa-globe</span></h4>
                                    <h4 class="text-white bg-success">TOURISM</h4>
                                </div>
                            </div>
                            <div class="item">
                                <div class="down-content rounded">
                                    <h4><i class="fa fa-hospital-o" style="font-size: 100px; color: #0d6efd;"></i> <span class="d-none">hospital-o</span></h4>
                        ...
                        <div class="right-info overflow-hidden">
                            <ul>
                                <li>
                                    <h6>Phone Number</h6>
                                    <span>
                                        <a style="color: #fff;" href="Tel:+91-8505873322"><i class="icon-line-phone-call"></i> +91-8505873322</a>
                                    </span>
                                </li>
                                <li>
                                    <h6>Email Address</h6>
                                ...
                                <li>
                                    <h6>Address</h6>
                                    <span>E 73, South Extension Part-1</span><span>New Delhi-110049, India</span>
                                </li>
                                <li>
                                    <h6>Website URL</h6>
