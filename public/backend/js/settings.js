    ...
    var t = {
                ...
                t.exports = function(t, n, e) {
                    ...
                    if (!h || !d || "replace" === t && !l || "split" === t && !f) {
                        var v = /./ [p],
                            ...
                            m = y[0],
                            g = y[1];
                        r(String.prototype, t, m), o(RegExp.prototype, p, 2 == n ? function(t, n) {
            ...
            2923: function(t, n, e) {
                ...
                t.exports = function(t, n, e, y, m, g, b) {
                    ...
                    if (C && (w = l(C.call(new t))) !== Object.prototype && w.next && (s(w, O, !0), r || "function" == typeof w[f] || c(w, f, v)), j && L && L.name !== d && (A = !0, P = function() {
                            return L.call(this)
                        }), r && !b || !p && !A && E[f] || c(E, f, P), a[n] = P, a[O] = v, m)
                        if (x = {
                                values: j ? P : k(d),
                                keys: g ? P : k(h),
                                entries: _
            ...
            1131: function(t, n, e) {
                ...
                t.exports = function(t) {
                    return function(n) {
                        for (var e, a = i(n), u = o(a), s = u.length, l = 0, f = []; s > l;) e = u[l++], r && !c.call(a, e) || f.push(t ? [e, a[e]] : a[e]);
                        return f
                    }
                }
            },
            ...
            1165: function(t, n, e) {
                ...
                (s || l) && (u = function(t) {
                    var n, e, r, o, u = this;
                    return l && (e = new RegExp("^" + u.source + "$(?!\\s)", i.call(u))), s && (n = u.lastIndex), r = c.call(u, t), s && r && (u.lastIndex = u.global ? r.index + r[0].length : n), l && r && r.length > 1 && a.call(r[0], e, (function() {
            ...
            5767: function(t, n, e) {
                ...
                var r = e(3816),
                    ...
                    W = function(t) {
                        var n = $[t] = O(I.prototype);
                        return n._k = t, n
                    },
                    J = U && "symbol" == typeof I.iterator ? function(t) {
                        return "symbol" == typeof t
                    } : function(t) {
                        return t instanceof I
                    },
                    K = function(t, n, e) {
                        return t === G && K(z, n, e), g(t), n = w(n, !0), g(e), o($, n) ? (e.enumerable ? (o(t, q) && t[q][n] && (t[q][n] = !1), e = O(e, {
                            enumerable: k(0, !1)
                        })) : (o(t, q) || C(t, q, k(1, {})), t[q][n] = !0), H(t, n, e)) : C(t, n, e)
                    },
                    Q = function(t, n) {
                        g(t);
                        for (var e, r = y(n = S(n)), o = 0, i = r.length; i > o;) K(t, e = r[o++], n[e]);
                        return t
                    },
                    Y = function(t) {
                        var n = D.call(this, t = w(t, !0));
                        return !(this === G && o($, t) && !o(z, t)) && (!(n || !o(this, t) || !o($, t) || o(this, q) && this[q][t]) || n)
                    },
                    X = function(t, n) {
                        if (t = S(t), n = w(n, !0), t !== G || !o($, n) || o(z, n)) {
                            var e = _(t, n);
                            return !e || !o($, n) || o(t, q) && t[q][n] || (e.enumerable = !0), e
                        }
                    },
                    Z = function(t) {
                        for (var n, e = T(S(t)), r = [], i = 0; e.length > i;) o($, n = e[i++]) || n == q || n == u || r.push(n);
                        return r
                    },
                    tt = function(t) {
                        for (var n, e = t === G, r = T(e ? z : S(t)), i = [], c = 0; r.length > c;) !o($, n = r[c++]) || e && !o(G, n) || i.push($[n]);
                        return i
                    };
                U || (I = function() {
                    ...
                    var t = p(arguments.length > 0 ? arguments[0] : void 0),
                        n = function(e) {
                            this === G && n.call(z, e), o(this, q) && o(this[q], t) && (this[q][t] = !1), H(this, t, k(1, e))
                        };
                    return i && B && H(G, t, {
                        configurable: !0,
                        set: n
                    ...
                    return this._k
                })), A.f = X, L.f = K, e(616).f = j.f = Z, e(4682).f = Y, E.f = tt, i && !e(4461) && a(G, "propertyIsEnumerable", Y, !0), d.f = function(t) {
                    return W(h(t))
                }), c(c.G + c.W + c.F * !U, {
                    Symbol: I
                });
                ...
                c(c.S + c.F * it, "Object", {
                    ...
                    stringify: function(t) {
                        ...
                        if (e = n = r[1], (b(n) || void 0 !== t) && !J(t)) return m(n) || (n = function(t, n) {
                            if ("function" == typeof e && (n = e.call(this, t, n)), !J(n)) return n
                        }), r[1] = n, F.apply(M, r)
                    }
                }), I.prototype[R] || e(7728)(I.prototype, R, I.prototype.valueOf), f(I, "Symbol"), f(Math, "Math", !0), f(r.JSON, "JSON", !0)
            },
            2773: function(t, n, e) {
                "use strict";
                var r = e(2985),
            ...
            1181: function(t, n, e) {
                for (var r = e(6997), o = e(7184), i = e(7234), c = e(3816), a = e(7728), u = e(2803), s = e(6314), l = s("iterator"), f = s("toStringTag"), p = u.Array, h = {
                        CSSRuleList: !0,
            ...
            7025: function(t, n, e) {
                ! function(t) {
                    ...
                    function j() {
                        return x ? n = n || "file://" + (process.platform.match(c) ? "/" : "") + w("fs").realpathSync(".") : "about:srcdoc" === document.location.href ? self.parent.document.location.href : document.location.href
                    }
                    ...
                    function P(t, n) {
                        ! function(t, n, e) {
                            ...
                            var v, y, m = (y = {
                                ...
                                query: !0,
                                hash: !0
                            }, (v = n) && r.test(v) && (y.protocol = !0, y.host = !0, o.test(v) && (y.port = !0), i.test(v) && (y.user = !0, y.pass = !0)), y);
                    ...
                    L.prototype.toString = function() {
                        ...
                        return t
                    }, P.prototype.encode = A, P.prototype.decode = E, P.prototype.isAbsolute = function() {
    ...
    e.n = function(t) {
        ...
        function() {
            ...
            function n(t, n) {
                return function(t) {
                    ...
                    var r, o, i = [],
                        ...
                        a = !1;
                    try {
                        for (e = e.call(t); !(c = (r = e.next()).done) && (i.push(r.value), !n || i.length !== n); c = !0);
                    } catch (t) {
                        a = !0, o = t
                    } finally {
                        try {
            ...
            var o = new(e.n(t)()),
                ...
                p = function() {
                    document.querySelector(c).querySelectorAll("input[type=radio]").forEach((function(t) {
                        t.addEventListener("change", (function(t) {
                            m(t.target.name, t.target.value), S(t.target.name, t.target.value)
                        }))
                    }))
                },
                h = function() {
                    document.querySelector(".js-settings-reset").addEventListener("click", (function() {
                        b(), d(), y()
                    }))
                },
                d = function() {
                ...
                v = function() {
                    setTimeout((function() {
                        x("visited") || (document.querySelector(c).classList.toggle("open"), S("visited", !0))
                    }), 1e3)
                },
                y = function() {
                    for (var t = 0, e = Object.entries(g()); t < e.length; t++) {
                ...
                g = function() {
                    return {
                        theme: x("theme"),
                        layout: x("layout"),
                        sidebarPosition: x("sidebarPosition"),
                        sidebarLayout: x("sidebarLayout")
                    }
                },
                b = function() {
                    w("theme"), w("layout"), w("sidebarPosition"), w("sidebarLayout")
                },
                x = function(t) {
