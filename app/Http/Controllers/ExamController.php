...
class ExamController extends Controller
{
    ...
    public function index()
    {
       ...
       $datas = Page::where('post_type','exam')->orderBy('id', 'ASC')->get();
        return view('backend.exam.list', compact('datas'));
    }
    ...
    public function show(Request $request)
    {
		...
		return view('backend.exam', compact('datas'));
    }
    ...
    public function edit(Request $request, $id)
    {
        //
        $item= Page::find($id);
		return view('backend.exam.create', compact('item'));
    }
